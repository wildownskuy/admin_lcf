...
export default function Artikel() {
  ...
  ProductDetails = currentPosts.map((item, index) => {
    ...
    return (
      ...
      <td className="px-6 py-4 w-[260px] flex max-h-52 overflow-y-auto">
      <textarea readOnly value={item.content} style={{width:190}} disabled className="cursor-default resize-none border-none  "/>
      </td>
      <td className="px-6 py-4 w-[200px] flex max-h-52  ">
        <textarea readOnly value={item.location} style={{width:180}} disabled className="cursor-default resize-none border-none  "/>
      </td>
      <td className="px-6  py-4 w-[130px]   flex max-h-52 overflow-y-auto">
